<?php
    ...
    $querySlug = $_GET['slug'];
    $sql = "SELECT pageName , category_slug , slug FROM post WHERE `category_slug`='python' ORDER BY `orderBy` ASC";
    $sql2 = "SELECT pageName , title , metaTitle , content , category_slug FROM `post` WHERE `category_slug`='python' AND slug='$querySlug'";
